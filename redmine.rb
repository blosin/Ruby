...
Redmine::MenuManager.map :top_menu do |menu|
  # The next line is commented to remove the link to /home from the top-menu.
  # menu.push :home, :home_path
  menu.push :my_page, { :controller => 'my', :action => 'page' }, :if => Proc.new { User.current.logged? }
  menu.push :projects, { :controller => 'projects', :action => 'index' }, :caption => :label_project_plural
  menu.push :administration, { :controller => 'admin', :action => 'index' }, :if => Proc.new { User.current.admin? }, :last => true
 #menu.push :Alarms, { :controller => 'form_cron', :action => 'index' }, :if => Proc.new { User.current.admin? }, :last => true
  menu.push :Events, { :controller => 'form_cron', :action => 'index' }, :if => Proc.new { User.current.admin? || User.verificarCordinador!='[]' }, :last => true
  menu.push :Help, :controller => 'wiki', :project_id => 'naos', :action => 'show', :id => 'wiki', :last => true
end
...
Redmine::MenuManager.map :application_menu do |menu|
  ...
  # The next line is commented to remove the link to issues/gantt from the application menu.  
  ...
  # The next line is commented to remove the link to /issues/calendar from the application menu.  
  ...
  # The next line is commented to remove the link to /issues/news from the application menu.
  # menu.push :news, {:controller => 'news', :action => 'index'},
  #   :if => Proc.new {User.current.allowed_to?(:view_news, nil, :global => true)},
  #   :caption => :label_news_plural
  
  # The next line is commented to remove old Resolution_time
  #menu.push :Resolution_time, { :controller => 'averages_times', :action => 'index' }, :if => Proc.new { User.current.admin? }, :last => true

  menu.push :Resolution_time, { :controller => 'averages_times', :action => 'index' }, :if => Proc.new { User.current.admin? || User.verificarCordinador!='[]' }, :last => true
end
...
Redmine::MenuManager.map :admin_menu do |menu|
  ...
  menu.push :backup, { :controller => 'form_backup', :action => 'index' }, :caption => "Manage backup" , :last => true,
            :html => {:class => 'icon icon-settings'}
