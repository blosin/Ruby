...
Rails.application.routes.draw do  
  ...
  # Change root home page, the user is redirected to my/page after login.
  ...
  get 'form_cron/index', :to => 'form_cron#index'
  get 'form_backup/index', :to => 'form_backup#index'
  get 'averages_times/index', :to => 'averages_times#index' 
  
  get 'cron_api', :to => 'cron_api#get'
  post 'cron_api/postAllIssuesAllProjects', :to => 'cron_api#postAllIssuesAllProjects'
  post 'cron_api/postOneProjectAllIssues', :to => 'cron_api#postOneProjectAllIssues'
  post 'cron_api/postQueryGeneral', :to => 'cron_api#postQueryGeneral'
  post 'cron_api/postOneProjectOneIssue', :to => 'cron_api#postOneProjectOneIssue'
  post 'cron_api/postReminder', :to => 'cron_api#postReminder'
  get 'cron_api/getQuerys', :to => 'cron_api#getQuerys'
  delete 'cron_api/delete', :to => 'cron_api#delete'
  post 'cron_api/postBackup', :to => 'cron_api#postBackup' 
  get 'cron_api/postBackupNow', :to => 'cron_api#postBackupNow' 

  get 'api_key/getKey', :to => 'api_key#get' 

  #AGREGADO
  get 'issues_api/getUsuarios', :to => 'average_resolution#getUsuarios'
  #AGREGADO
  get 'issues_api/getUser', :to => 'average_resolution#getUsuario'

  
  get 'issues_api/getCategories', :to => 'average_resolution#getCategorias'
  get 'issues_api/getinfoCategory', :to=> 'average_resolution#getCategoriaInfo'
  
  get 'issues_api/AvgProject', :to => 'average_resolution#getAverages1Proyecto'
  get 'issues_api/AvgPryCat', :to => 'average_resolution#getAverages1Proyecto1Categoria'
  get 'issues_api/AvgPryAllCat', :to => 'average_resolution#getAverages1ProyectoTodasCategorias'
  get 'issues_api/AvgAllProjects', :to => 'average_resolution#getAveragesTodosProyectos0categoria'
  
  get 'issues_api/projects', :to => 'average_resolution#getProyectos'
